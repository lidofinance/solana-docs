...
<!--img src="./images/common/wallet_list.png" alt="wallet_list" width="350"/-->
<!--[Wallets](./images/common/wallet_list.png)-->
...
![Create](./images/sollet/create_sollet_wallet.png)
...
![Restore](./images/sollet/restore_existing_sollet.png)
![Restore](./images/sollet/restore_sollet_account.png)
...
<img src="./images/sollet/wallet_list_sollet.png" alt="wallet_list" width="350"/>
...
![Approve-connection](./images/sollet/Sollet_approve.png)
...
![Connected](./images/common/connected_widget.png)
...
![Transaction](./images/common/tx_params.png)
...
![Approve1](./images/sollet/sollet_approve1.png)

After verifying the information you can approve now.

![Approve2](./images/sollet/sollet_approve2.png)
...
<img src="./images/common/update.png" alt="update" width="450"/>
