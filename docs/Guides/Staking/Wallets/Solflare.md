...
![Create](./images/solflare/create1.png)
![Create](./images/solflare/create2.png)
![Create](./images/solflare/create3.png)
![Create](./images/solflare/create4.png)
![Create](./images/solflare/create5_alt.png)
...
![Restore](./images/solflare/restore1.png)
![Restore](./images/solflare/restore2.png)

### Logged In
Once you have funded your Solflare wallet with Solana, you can log in to solflare webapp to see your account details.
<img src="./images/solflare/logged_in.png" alt="logged_in" width="1050">
...
![Connected](./images/solflare/connected_widget.png)
...
![Account](./images/solflare/account_info.png)

<img src="./images/solflare/connect_dialog_2.png" alt="connect_dialog" width="700"/>
...
![Transaction](./images/solflare/tx_params.png)
...
![Lido](./images/common/lido_params.png)
...
<img src="./images/solflare/staking.png" alt="staking" width="850"/>
...
![Approve1](./images/solflare/approve1.png)

After verifying the information you can approve now.

![Approve2](./images/solflare/approve2.png)
...
![Conf1](./images/solflare/confirmations1.png)
![Conf2](./images/solflare/confirmations2.png)
![Conf3](./images/solflare/confirmations3.png)

Finally, after 32 confirmations the transaction gets confirmed. The lido widget will reflect the new balance

![Conf4](./images/solflare/confirmations4.png)
...
<img src="./images/solflare/update.png" alt="update" width="850"/>
<img src="./images/solflare/updated.png" alt="updated" width="850"/>
