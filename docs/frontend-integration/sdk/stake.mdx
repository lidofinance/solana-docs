...
type setTxStage = (props: {
  ...
  deactivatingSolAccountAddress?: PublicKey; // TX_STAGE.AWAITING_SIGNING unstake instructions
  stSolAccountAddress?: PublicKey; // TX_STAGE.AWAITING_SIGNING stake instructions
}) => void;
