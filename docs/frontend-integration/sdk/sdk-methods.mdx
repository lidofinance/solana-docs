...
```ts
type setTxStage = (props: {
  txStage: TX_STAGE;
  transactionHash?: TransactionSignature; // TX_STAGE.AWAITING_BLOCK
  stSolAccountAddress?: PublicKey; // TX_STAGE.AWAITING_SIGNING
}) => void;
...
type setTxStage = (props: {
  txStage: TX_STAGE;
  transactionHash?: TransactionSignature; // TX_STAGE.AWAITING_BLOCK
  deactivatingSolAccountAddress?: PublicKey; // TX_STAGE.AWAITING_SIGNING instructions
}) => void;
